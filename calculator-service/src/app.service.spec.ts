...
describe('AppController', () => {
    ...
    describe('root', () => {
        it('Calculator should return score 40', async () => {
            ...
            expect(await appService.calculateBowlingScore(rounds)).toBe(38)
        });
    });
    ...
    describe('FiveRoundTest', () => {
        it('Current Score should return 100', async () => {
            ...
            expect(await appService.calculateBowlingScore(rounds)).toBe(100)
        });
    });
    ...
    describe('perfectGame', () => {
        it('Calculator should return score 300', async () => {
            ...
            expect(await appService.calculateBowlingScore(rounds)).toBe(300)
        });
    });
});